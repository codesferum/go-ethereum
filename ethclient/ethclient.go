...
import (
	...
	"github.com/codesferum/go-sferum"
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, sferum.NotFound
	}
...
func (ec *Client) SyncProgress(ctx context.Context) (*sferum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (sferum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q sferum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q sferum.FilterQuery, ch chan<- types.Log) (sferum.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q sferum.FilterQuery) interface{} {
...
func (ec *Client) CallContract(ctx context.Context, msg sferum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg sferum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg sferum.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg sferum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
