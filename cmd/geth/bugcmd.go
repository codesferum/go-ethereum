...
import (
	...
	"github.com/codesferum/go-sferum/cmd/internal/browser"
...
const issueUrl = "https://github.com/codesferum/go-sferum/issues/new"

// reportBug reports a bug by opening a new URL to the go-sferum GH issue
