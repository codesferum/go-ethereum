...
//
// Detailed usage document and tutorial available on the go-sferum Wiki page:
// https://github.com/codesferum/go-sferum/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
import (
	...
	"github.com/codesferum/go-sferum/accounts/abi"
